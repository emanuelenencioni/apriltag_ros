...
template <>
geometry_msgs::msg::Transform tf2::toMsg(const apriltag_pose_t& pose) {
...
template <>
geometry_msgs::msg::Transform tf2::toMsg(const std::pair<cv::Mat_<double>, cv::Mat_<double>>& pose) {
